...
namespace lab5_6
{
    ...
    public class Transport : BaseClone, ICloneable, ICloneable1 
    {
        ...
        public override void DoClone() //При переопределении в классе-наследнике используется ключевое слово override 
        {
        ...
        public partial class Car : Transport //класс partial
        {
    ...
    public class TransportAgency     //класс   "транспортное агенство"
    {
