...
namespace lab9
{
    ...
    public class User : EventArgs                  //класс пользователь с событиями upgrade и work
    {
        ...
        public void UserUpgrade(int num)                                    //событие upgrade
        {
            level += num;
            if (Upgrade != null)
            {
        ...
        public void UserWork(bool bl)                                        //событие work
        {
            if (Work != null)
            {
                if (bl)
    ...
    class Program
    {
        ...
        {
            User user1 = new User("Екатерина", 27, 3); // экземпляры
            ...
            Action<string> action;       //используем стандартный делегат для обработки строки
        ...
        static public void ShowMessage(string message) => Console.WriteLine(message);          //методы пользовательской обработки строки
        ...
        static public void AddSymbols(string str) => Console.WriteLine(str + "добавили символы");
